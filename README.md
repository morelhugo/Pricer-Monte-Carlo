...
- **CNormale** : Classe fille, cette classe hérite de **CProbaLawWithMoment** et permet de simuler la loi normale via la méthode de **Box-Muller**. Rapidement, sa définition mathématique est la suivante. Soient ![equation](<img src="http://www.sciweavers.org/tex2img.php?eq=U_1&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="U_1" width="24" height="18" />)


- <img src="http://www.sciweavers.org/tex2img.php?eq=U_1&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="U_1" width="24" height="18" />
